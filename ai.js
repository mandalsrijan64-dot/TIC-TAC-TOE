 ...
 *
 * The AI plays as 'O' (maximiser).
 * The human plays as 'X' (minimiser).
 *
 * Scores:
 *   AI  wins  →  +10 − depth  (prefer faster wins)
 *   Human wins → −10 + depth  (delay losses as long as possible)
 *   Draw       →   0
 */

let nodesSearched = 0; // exposed for UI display
